CREATE TABLE bw_file_management (
    ...
    user_id BIGINT NOT NULL,                       -- 关联的用户ID，用于区分每个用户的文件数据
    file VARCHAR(255) NOT NULL,                      -- 存储文件的路径，用于定位文件内容
    file_size BIGINT NOT NULL,                    -- 文件大小，单位为字节
    object_id VARCHAR(32) NOT NULL,             -- 文件所属的功能模块，例如“用户头像”
...
COMMENT ON COLUMN bw_file_management.object_id IS '关联对象id，例如“knowledge_id”';
